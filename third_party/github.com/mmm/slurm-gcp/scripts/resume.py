...
def main(arg_nodes, arg_job_id):
   ...
   # Get static node list
    ...
    if (arg_job_id and
        ...
        if cfg.instance_defs[pid].machine_type.split('-')[0] not in ['c2','c2d','a2']:
            msg = "Unsupported placement policy configuration. Please utilize c2, c2d, or a2 machine types."
            log.error(msg)
